...
function ServicePageSectionTwo(){
    return (
        <React.Fragment>
             <Card sx={{ marginBottom: 10 ,marginRight: 5 ,marginTop:5,paddingY:0,paddingX:1.2,width:"26%",}}>
          <CardContent>
            <Grid
              container
              spacing={2}
            ...
            >
              <Grid item>
              <TaskAltIcon style={{ color: "#3ee34e", border: "0px solid #e56e44", borderRadius: "0%", padding: "0px" }} />
              </Grid>
              <Grid item>
